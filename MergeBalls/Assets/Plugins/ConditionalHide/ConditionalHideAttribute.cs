...
public class ConditionalHideAttribute : PropertyAttribute
{
    ...
    public int ConditionalEnumValue;
    ...
    public ConditionalHideAttribute(string conditionalSourceField, int conditionalEnumValue, bool hideInInspector = true, bool inverse = false) {
        this.ConditionalSourceField = conditionalSourceField;
        this.ConditionalEnumValue = conditionalEnumValue;
        this.HideInInspector = hideInInspector;
        this.Inverse = inverse;
    }
    ...
    public ConditionalHideAttribute(string conditionalSourceField, bool hideInInspector, bool withRange, float min, float max) {
